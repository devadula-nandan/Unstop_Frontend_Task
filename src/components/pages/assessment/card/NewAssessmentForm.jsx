        ...
        <>
            ...
            <dialog id="my_modal_3" className="modal modal-bottom sm:modal-middle">
                <form method="dialog" className={"p-0 rounded-lg modal-box max-w-[36.937rem] w-full " }>
                    <button className="btn btn-sm btn-circle btn-ghost hover:bg-[#FBEBEA] hover:text-[#D63500] bg-[#FBEBEA] text-[#D63500] scale-105 md:bg-transparent md:text-[#1C4980] md:scale-100 absolute md:right-5 right-4 top-4">
