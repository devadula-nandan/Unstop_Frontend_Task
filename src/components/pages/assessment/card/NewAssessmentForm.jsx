            ...
            <div className='w-full border border-dashed group rounded-box bg-[#F6F8FA] p-[1rem] sm:p-3 md:p-[1.875rem] hover:bg-[#ebedf0] cursor-pointer'>
                ...
                <div>
                    ...
                    <form method="dialog" className={"p-0 rounded-t-lg transition-all duration-500 md:rounded-lg bg-white w-full fixed z-50 -bottom-[100vh] md:!bottom-auto md:top-[190vh] left-1/2 -translate-x-1/2 max-w-[37rem] md:-translate-y-1/2 " + (isOpen ? "!bottom-0 md:!top-1/2" : "")}>
                        ...
                        <h3 className="px-4 md:px-[1.88rem] py-5 font-semibold text-[#1C4980] text-sm md:text-xl border-b">Create new assessment</h3>
                        <div className='px-4 md:px-[1.88rem] overflow-auto max-h-[60vh] py-4'>
                            <div className="flex gap-5 flex-col form-control w-full">
                                <div>
                                    <label className="label pt-0">
                                        <span className="label-text text-[#1C4980] text-xs md:text-base font-medium">Name of assessment</span>
                                    </label>
                                    <input type="text" placeholder="Type Here" className="!outline-none input text-[#1C4980] font-medium text-xs  md:text-sm input-bordered w-full" />
                                </div>
                                <div>
                                    <label className="label pt-0">
                                        <span className="label-text text-[#1C4980] text-xs md:text-base font-medium">Purpose of the test is</span>
                                    </label>
                                    <select defaultValue="" className="!outline-none input text-[#1C4980] font-medium text-xs  md:text-sm w-full select select-bordered">
                                ...
                                <div>
                                    <label className="label pt-0">
                                        <span className="label-text text-[#1C4980] text-xs md:text-base font-medium">Description</span>
                                    </label>
                                    <select defaultValue="" className="!outline-none input text-[#1C4980] font-medium text-xs  md:text-sm w-full select select-bordered">
                                        <option disabled value="">Select</option>
                                ...
                                <div>
                                    <label className="label pt-0">
                                        <span className="label-text text-[#1C4980] text-xs md:text-base font-medium">Skills</span>
                                    </label>
                                    <div className="border rounded-lg border-[#DADCE0]">
                                        <div className="flex flex-wrap gap-1 md:gap-2 p-4">
                                            {skills.map((skill, index) => (
                                                <div className='rounded-full flex items-center bg-[#DDEDFF]' key={index}>
                                                    ...
                                                    <button onClick={(e) => { e.preventDefault(); setSkills(skills.filter((s) => skill !== s)) }} className='btn btn-xs md:btn-sm md:h-7 md:w-7 md:!min-h-0 btn-circle btn-link hover:bg-[#c2d6ee]'>
                                        ...
                                        <div className="border-t">
                                            <input type="text" placeholder="Type Here" className="!outline-none input text-[#1C4980] font-medium text-xs  md:text-sm w-full" />
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <label className="label pt-0">
                                        <span className="label-text text-[#1C4980] text-xs md:text-base font-medium">Duration of assessment</span>
                                    </label>
                                    <input type="text" placeholder="HH:MM:SS" className="!outline-none input text-[#1C4980] font-medium text-xs  md:text-sm input-bordered w-full" />
                                </div>
