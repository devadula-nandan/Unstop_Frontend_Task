        ...
        <div className='w-full border rounded-box'>
            <div className="flex justify-between items-start p-3">
                <div className=" flex gap-2">
                    ...
                    {/* below div shows only on mobile */}
                    <div className='lg:hidden mt-1'>
                        <h2 className=' text-sm text-[#1C4980] font-semibold'>Math Assessment</h2>
            ...
            <div className="px-3 pb-3">
                {/* below h2 & div shows only on desktop */}
                <h2 className='text-lg text-[#1C4980] font-medium hidden lg:block'>Math Assessment</h2>
                ...
                <div className="flex flex-wrap gap-y-2 justify-between items-center border-dashed border-t-[1.6px] pt-3">
                    ...
                    <div className='flex gap-1 md:gap-2'>
                        ...
                        <div className='flex ml-4'>
                            <span className='bg-[#6548EE] btn-circle btn-sm flex items-center justify-center text-white font-semibold border border-white -ml-4'>LP</span>
                            <span className='bg-[#3079E1] btn-circle btn-sm flex items-center justify-center text-white font-semibold border border-white -ml-4'>LP</span>
                            <span className='bg-[#E9407A] btn-circle btn-sm flex items-center justify-center text-white font-semibold border border-white -ml-4'>LP</span>
                        </div>
                    </div>
                </div>
            </div>
