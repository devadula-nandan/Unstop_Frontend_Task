...
function Assessment() {
    ...
    return (
        <div className='bg-base-100 rounded-box'>
            <div className="flex gap-3 px-0 lg:px-5 border-b">
                ...
                <div className="tabs">
                    <a className="tab text-[0.875rem] h-auto tab-bordered font-semibold py-3 lg:py-5 text-[#0073E6] border-b-2 border-[#0073E6]">My Assessments</a>
                    <a className="tab text-[0.875rem] h-auto tab-bordered font-semibold py-3 lg:py-5 text-[#1C4980] border-transparent">Unstop Assessments</a>
                </div>
            </div>
            <div className="lg:px-5 lg:pb-5 lg:pt-4 px-3 pb-3 pt-4">
                ...
                <div className="flex justify-between lg:hidden">
                    ...
                    <div className='flex gap-1'>
                        <button onClick={() => { setBtnState({ ...btnState, search: !btnState.search }) }} className={'btn btn-sm lg:hover:bg-[#F2F8FE] btn-circle btn-link text-[#1C4980] ' + (btnState.search ? "!text-[#0073E6] bg-[#F2F8FE] border-[#0073E6]" : "")}>
                        ...
                        <button onClick={() => { setBtnState({ ...btnState, filter: !btnState.filter }) }} className={'btn btn-sm lg:hover:bg-[#F2F8FE] btn-circle btn-link text-[#1C4980] ' + (btnState.filter ? "!text-[#0073E6] bg-[#F2F8FE] border-[#0073E6]" : "")}>
                        ...
                        <button onClick={() => { setShowMobileOverview(!showMobileOverview); setBtnState({ ...btnState, overview: !btnState.overview }) }} className={'btn btn-sm lg:hover:bg-[#F2F8FE] btn-circle btn-link text-[#1C4980] ' + (btnState.overview ? "!text-[#0073E6] bg-[#F2F8FE] border-[#0073E6]" : "")}>
