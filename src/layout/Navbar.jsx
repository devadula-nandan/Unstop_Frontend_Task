            ...
            <div className="lg:absolute top-0 drawer drawer-start w-auto px-3 pt-2 md:pt-3 lg:hidden items-center">
                ...
                <div className="drawer-side z-10">
                    ...
                    <ul className="menu gap-2 px-4 py-6 w-full max-w-[280px] h-full bg-[#F2F8FE] text-base-content">
                        <li onClick={blurEl} className='flex-row items-center'>
                            <p className='px-0 pointer-events-none text-sm font-medium text-[#1C4980]'>Menu</p>
                            <button onClick={() => { document.getElementById("my-drawer").checked = false }} className="ml-auto p-1 text-[#1C4980] rounded-circle h-8 w-8 flex items-center justify-center">
                        ...
                        <li className='mt-4'>
                            <a onClick={() => { setActive("dashboard"); document.getElementById("my-drawer").checked = false; navigate("/dashboard") }} className={"px-2 py-[0.62rem] hover:bg-[#E5F1FC] text-[#1C4980] hover:text-[#0073E6] text-sm font-semibold active:!bg-[#E5F1FC] active:!text-[#1C4980] border border-transparent " + (active == "dashboard" ? "bg-[#E5F1FC] !border-[#0073E6] border !text-[#0073E6]" : "")}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="currentColor">
                                    <g>
                                        <path d="M15.8333 4.66667V6.33333H12.5V4.66667H15.8333ZM7.5 4.66667V9.66667H4.16667V4.66667H7.5ZM15.8333 11.3333V16.3333H12.5V11.3333H15.8333ZM7.5 14.6667V16.3333H4.16667V14.6667H7.5ZM17.5 3H10.8333V8H17.5V3ZM9.16667 3H2.5V11.3333H9.16667V3ZM17.5 9.66667H10.8333V18H17.5V9.66667ZM9.16667 13H2.5V18H9.16667V13Z" fill="currentColor" />
                                    </g>
                                    <defs>
            ...
            <div className=" min-h-screen h-full pr-2 hidden lg:block">
                <div className="h-full bg-white">
                    <ul className="menu pl-[1.88rem] pt-4 pr-5 pb-5 gap-2 sticky top-0">
                        <li>
                            <a onClick={() => { navigate('/dashboard'); setActive("dashboard") }} className={"px-2 py-2 hover:bg-[#E5F1FC] text-[#1C4980] hover:text-[#0073E6] active:!bg-[#E5F1FC] active:!text-[#1C4980] flex flex-col border border-transparent " + (active == "dashboard" ? "bg-[#E5F1FC] !border-[#0073E6] border !text-[#0073E6]" : "")} >
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="currentColor">
                                    <g>
                                        <path d="M15.8333 4.66667V6.33333H12.5V4.66667H15.8333ZM7.5 4.66667V9.66667H4.16667V4.66667H7.5ZM15.8333 11.3333V16.3333H12.5V11.3333H15.8333ZM7.5 14.6667V16.3333H4.16667V14.6667H7.5ZM17.5 3H10.8333V8H17.5V3ZM9.16667 3H2.5V11.3333H9.16667V3ZM17.5 9.66667H10.8333V18H17.5V9.66667ZM9.16667 13H2.5V18H9.16667V13Z" fill="currentColor" />
                                    </g>
                        ...
                        <li>
                            <a onClick={() => { navigate('/assessment'); setActive("assessment") }} className={"px-2 py-2 hover:bg-[#E5F1FC] text-[#1C4980] hover:text-[#0073E6] active:!bg-[#E5F1FC] active:!text-[#1C4980] flex flex-col border border-transparent " + (active == "assessment" ? "bg-[#E5F1FC] !border-[#0073E6] border !text-[#0073E6]" : "")}>
                        ...
                        <div className=' border-dashed border-b rounded-none my-3'></div>
                        <li>
                            <a onClick={() => { setActive("status") }} className={"px-2 py-2 hover:bg-[#E5F1FC] text-[#1C4980] hover:text-[#0073E6] active:!bg-[#E5F1FC] active:!text-[#1C4980] flex flex-col border border-transparent " + (active == "status" ? "bg-[#E5F1FC] !border-[#0073E6] border !text-[#0073E6]" : "")}>
                                <div className="badge mb-1 text-[#D63500] text-[0.625rem] font-medium bg-[#FBEBEA] badge-outline">Admin</div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                <p className=' font-semibold text-xs'>Round<br />Status</p>
                            </a>
                        </li>
                    </ul>
                </div>
